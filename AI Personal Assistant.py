...
def wishme():
    welcome_message = f"Welcome Back Hamza"
    ...
    def clicked(self):
        ...
        if 'time' in query:
           show_time()
            ...
            url = 'Api_from_https://api.openweathermap.org'
